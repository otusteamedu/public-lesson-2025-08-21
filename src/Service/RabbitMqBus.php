...
class RabbitMqBus
{
    ...
    public function registerProducer(AmqpExchange $exchange, ProducerInterface $producer): void
    {
        $this->producers[$exchange->value] = $producer;
    }

    public function publishToExchange(AmqpExchange $exchange, $message, ?string $routingKey = null, ?array $additionalProperties = null): bool
    {
    ...
    public function publishMultipleToExchange(AmqpExchange $exchange, array $messages, ?string $routingKey = null, ?array $additionalProperties = null): bool
    {
        $sentCount = 0;
